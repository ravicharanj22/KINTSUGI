    ...
    return (
        <div className={classes.cover}>
            ...
            <form className={classes.formContainer}>
                ...
                <Button type="submit" className={classes.button} onClick={removeAvax}>
                    {/* {loading && (
            <CircularProgress className={`${classes.loading}`} size={24} />
          )} */}
                    Remove Avalanche Liquidity
                </Button>

                <Button type="submit" className={classes.button} disabled={loading} onClick={removeAlgo}>
                    {loading && (
                        <CircularProgress className={`${classes.loading}`} size={24} />
                    )}
                    Remove Algorand Liquidity
                </Button>
            </form>
